...
# ─── Security ──────────────────────────────────────────────────────────────
SECRET_KEY = os.environ.get('SECRET_KEY','django-insecure-^3%c1i6c734j=k9x7+x5c)7g0g#j_g380q_08(l#c=6=1a_5h1')
...
# ─── Custom User Model (DISABLED - using default auth.User for now) ──────────
...
# ─── CORS (allow Flutter web app to call from any origin) ─────────────────
